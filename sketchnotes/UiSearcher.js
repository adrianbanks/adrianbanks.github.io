...
export class UiSearcher { 
    ...
    #displayPage(data, pageNo) {
        ...
        this.#sketchnotesArea.loadTemplate("sketchnote.html", data, { isFile: true, paged: true, pageNo: pageNo, elemPerPage: resultsPerPage, bindingOptions: { ignoreUndefined: true }, complete: complete});
